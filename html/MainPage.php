...
<head>
  ...
  <link
    href="https://fonts.googleapis.com/css2?family=Amiri:wght@700&family=Open+Sans:wght@300&family=Reem+Kufi+Fun:wght@400;500&family=Scheherazade+New:wght@400;500;600;700&display=swap"
    rel="stylesheet">
...
<body>
  ...
  <section class="firstsection">
    <div class="container">
      <div class="vector1">
        <img src="../imgs/MainVector.png" alt="Vector">
      </div>
      <div class="paragraph">
        <h1>مركز <span>قدس</span> للتبرع بالدم</h1>
        <br>
        <h3>التبرع بالدم: نبض العطاء الذي يحيي <span>الحياة!</span></h3>
        <p>التبرع بالدم هو عمل إنساني حقيقي يعكس التضامن والعطاء. عندما تتبرع بالدم، فإنك تقدم هبة تعزز الحياة وتعطي
          فرصة للأشخاص الذين يحتاجون إلى نقل الدم للشفاء أو للتخفيف من آلامهم.</p>
      </div>
    </div>
  </section>
  <!-- End Section -->
<section>
  <div class="container">
        <div class="row d-flex">
          <div class="col-md-4 ">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3374.7199999921477!2d35.24330697517317!3d32.23870491130237!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x151ce04dc8137de7%3A0x6442b7658784fe51!2z2YXYs9iq2LTZgdmJINin2YTZhtis2KfYrSDYp9mE2KzYp9mF2LnZig!5e0!3m2!1sen!2s!4v1691682649217!5m2!1sen!2s" width="500" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </div>
          <div class="col-md-4 offset-md-1 about-content me-auto ">
            <h2 class="bs-danger">من نحن ؟</h2>
            <br>
            <p class=" text-center">بنك القدس للتبرع بالدم هو مؤسسة طبية تهدف إلى جمع وتخزين وتوزيع وإدارة تبرعات الدم. يقوم بنك الدم بدور حيوي في توفير وتأمين الدم ومشتقاته للمرضى الذين يحتاجون إلى نقل دم بسبب حوادث، أو عمليات جراحية، أو حالات طبية مزمنة، أو أمراض دموية. يتم جمع الدم من المتبرعين الطوعيين، حيث يتم فحص الدم بعد التبرع لضمان سلامته وخلوه من أي عوامل معدية أو مشكوك فيها.

يتم تجميع الدم في بنك الدم وتخزينه بشكل آمن وفقًا للمعايير الطبية والصحية. يتم تقسيم الدم المجموع إلى مكوناته الرئيسية، مثل الكريات الحمراء والبلازما والصفائح الدموية، وذلك لتلبية احتياجات مختلفة للمرضى.

بنك الدم يلعب دورًا حيويًا في الرعاية الصحية بتوفير مخزون آمن من الدم لضمان توفيره في الوقت المناسب للمرضى. تعتمد استدامة بنك الدم على التبرع المنتظم والوعي المجتمعي بأهمية التبرع بالدم لإنقاذ الأرواح ودعم العلاجات الطبية.</p>
  ...
  <!--Hover ar Label-->
  <div class="benefits">فوائد التبرع بالدم</div>

  <div class="BenefitsArticles">
    <div class="container">
      <div class="box">
        <div class="img"><img src="../imgs/soul.png" alt="Soul Img"></div>
        <div class="content">
          <h3>إنقاذ الأرواح</h3>
  ...
  <div class="container" >
    <div class="review_body"> <!--flex-->
      <div class="element"> <!-- start element 1-->
        ...
        <div class="content"> <!-- start content element 1-->

          <h2 class="title"> جودة الدم </h2> <!--title-->

          <i class="icon_element"><!--icon-->
            <i class="fa-solid fa-vial-circle-check fa-xl" style="color: #cc0000;"></i>
          </i>
          <!--para-->
          <p class="text">نعمل على تطبيق لمعايير الجودة المعترف بها على مستوى الوطني او الدولي هذه المعايير تشمل سلامة
            الدم والفحوصات المخبرية وتجهيز وحدات الدم ونقلها</p>
      ...
      <div class="element"> <!-- start element 4-->
        ...
        <div class="content"> <!-- start content element 4-->

          <h2 class="title"> سلامة المتبرعين </h2>
          <i class="icon_element">
            <i class="fa-solid fa-briefcase-medical fa-2xl" style="color: #cc0000;"></i>

          </i>
          <p class="text"> نحرص على اجراء فحص للمتبرعين للتأكد من توافقهم مع معايير التبرع بالدم وتأكد من عد وجود اي
            امراض معدية</p>

          <button class="Btn" onclick="handleLikeIncremntal('like-count-4')"><!-- button like-->
            <span class="leftContainer">
              <svg fill="white" viewBox="0 0 512 512" height="1em" xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M47.6 300.4L228.3 469.1c7.5 7 17.4 10.9 27.7 10.9s20.2-3.9 27.7-10.9L464.4 300.4c30.4-28.3 47.6-68 47.6-109.5v-5.8c0-69.9-50.5-129.5-119.4-141C347 36.5 300.6 51.4 268 84L256 96 244 84c-32.6-32.6-79-47.5-124.6-39.9C50.5 55.6 0 115.2 0 185.1v5.8c0 41.5 17.2 81.2 47.6 109.5z">
            ...
            <span class="likeCount" id="like-count-4">
              677
            </span>
          </button>

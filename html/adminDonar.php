...
if (isset($_POST["firstName"])) {
  ...
  if ($password!=$confirmPassword)
    echo "Enter Two identical Password";
      ...
      $sqlQuery = "INSERT INTO `donars` (`FirstName`, `SecondName`, `UserName`, `Email`, `City`, `PhoneNumber`, `BirthDate`, `BloodType`, `Password`) VALUES ('$fName', '$SName', '$userName', '$email', '$city', '$phoneNumber', '$birthDay', '$bloodType', SHA1($password))";
...
$random = $_POST["id"];
echo $random;
$sqlQuery = "Delete from `donars` where `UserName` ='". $random ."'";
$conn = new mysqli("localhost", "root" , "", "web_project");
$conn->query($sqlQuery);
}
?>
...
<head>
  ...
  <body id="body-pd">
        ...
        <nav class="nav">
            <div> 
              <a href="admin.php" class="nav_logo" style="text-decoration: none;"> 
                ...
                <span class="nav_logo-name">Donar Page</span> 
              </a>
                <div class="nav_list"> 
                  ...
                  </a> <a href="adminDonar.php" class="nav_link active"> 
          ...
          <div class="col-lg-12 col-xl-12">
            <div class="card flex-row my-4 border-0 shadow rounded-3 overflow-hidden">
              <div class="card-body p-1 p-sm-5">
                <h5 class="card-title text-center mb-4 fw-light fs-5">Donar Register</h5>
                <form action="adminDonar.php" method="post" id='formId'>    
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div style="display: flex; justify-content: flex-end; align-items: center;">
                          <i class="fa-solid fa-trash" style="color: #bc3737; font-size: 25px; margin: 10px;"onclick="deleteDonar()"></i>
                        </div>
    ...
    <script src="../js/adminDonar.js"></script> 
</body>
</html>